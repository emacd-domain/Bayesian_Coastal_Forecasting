...
# set directory 
NNSdirectory = cwd+r'\..\O7_lstm_train\wave_period_models'
...
test = (targets_test[:, -1]*dm_stdevs[0, target_id])+dm_means[0, target_id]

robust_save = (robust_prediction[0], robust_prediction[1], robust_prediction[2], test)

np.savetxt('ABMS_wave_period_output.csv', robust_save, delimiter=',')

make_plots(variable='Mean Wave Period', 
