...
while i<9:
    ...
    plt.plot([0, 3.5], [0, 3.5], 'r-.', linewidth=1)
    plt.plot([0, 3.5], [0.3, 3.8], 'r:', linewidth=1.5, label='+/- 0.3')
    plt.plot([0, 3.5], [-0.3, 3.2], 'r:', linewidth=1.5)
    plt.grid(color='r', linestyle=':', linewidth=0.5)
    plt.xlim([0, 3.5])
    plt.ylim([0, 3.5])
    plt.title("Network "+str(i), fontdict={'fontsize' : 18})
    plt.xlabel("Observed Hs [m]", fontdict={'fontsize' : 18})
    plt.ylabel("Predicted Hs [m]", fontdict={'fontsize' : 18})
    plt.legend()
    ...
    MODELNAME = "FOC_HS_24HOUR_FORECAST_MODEL_"+str(i)
